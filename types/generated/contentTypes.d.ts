...
export interface ApiAffiliateLinkAffiliateLink extends Schema.CollectionType {
  ...
  attributes: {
    ...
    conversion_rate: Attribute.Float;
...
export interface ApiAnalyticAnalytic extends Schema.CollectionType {
  ...
  attributes: {
    ...
    page_views: Attribute.Integer;
    unique_visitors: Attribute.Integer;
    bounce_rate: Attribute.Float;
    average_time_on_page: Attribute.Float;
    landing_page: Attribute.Relation<
...
export interface ApiLandingPageLandingPage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    analytic: Attribute.Relation<
      'api::landing-page.landing-page',
      'oneToOne',
      'api::analytic.analytic'
    >;
    affiliate_links: Attribute.Relation<
      'api::landing-page.landing-page',
      'oneToMany',
      'api::affiliate-link.affiliate-link'
    >;
...
export interface ApiLayoutLayout extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    header: Attribute.JSON;
    footer: Attribute.JSON;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
